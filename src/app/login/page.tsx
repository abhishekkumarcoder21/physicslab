...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 relative">
      {/* Decorative blobs */}
      <div className="fixed top-20 left-20 w-72 h-72 bg-primary/10 rounded-full blur-[100px]" />
      <div className="fixed bottom-20 right-20 w-64 h-64 bg-accent/10 rounded-full blur-[100px]" />
      ...
      <div className="w-full max-w-md animate-fade-in">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-text-muted">Sign in to continue your physics journey</p>
        </div>
        ...
        <div className="rounded-3xl bg-surface-card border border-border p-8 backdrop-blur-xl shadow-xl">
          ...
          <div className="mt-6 pt-6 border-t border-border text-center">
            <p className="text-sm text-text-muted">
              ...
              <Link href="/signup" className="font-semibold text-primary hover:text-primary-light transition-colors">
                Sign Up
              </Link>
            </p>
          </div>
